	...
	<div class="row-fluid sortable">
				<div class="box span12">
                    ...
                    <?php echo form_open_multipart('admin/saveobat');?>
<?php
						...
						<div class="form-horizontal">
						  ...
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge datepicker" id="date01" name="expired">
								</div>
							</div>
                            <div class="control-group">
							  <label class="control-label" for="typeahead">Tanggal Masuk</label>
							  <div class="controls">
								<input type="text" class="input-xlarge datepicker" id="date02" name="tgl_masuk">
								</div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="typeahead">Tanggal Edit</label>
							  <div class="controls">
							  <input type="text" class="input-xlarge datepicker" id="date03" name="tgl_edit">
								</div>
							</div>
